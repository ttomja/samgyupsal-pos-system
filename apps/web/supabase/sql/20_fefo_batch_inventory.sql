...
-- Compatibility catch-up for databases that have the flattened products table
-- but have not yet applied the operational branch_id/is_active alignment.
-- These are additive only and keep branch text as the fallback for older rows.
